...
namespace nc::managers {
    ...
    void RenderManager::submit(std::unique_ptr<graphics::renderCommands::RenderCommand> rc) { m_renderCommands.push(std::move(rc)); }
    ...
    void RenderManager::setClearColor(float r, float g, float b, float a) { glClearColor(r, g, b, a); }
